...
> 大部分电脑还可以通过按下电源按钮关机，但这种方式会受到Windows的电源设置影响，有时候使用这种方式不一定能成功关机。
> 还有……显示器上的电源按钮不是电脑的电源按钮，千万不要把这个按钮当做“一键关机”来用！（一体机除外）
>
> 另外：**尽可能避免**通过拔电源线或拉闸的方式关闭电脑，这极有可能对电脑造成伤害（笔记本除外，但它需确保电池电量充足），写这句话的人就曾经经历过因同学拉闸导致系统崩溃的问题
